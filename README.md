...
geoportal del INE. Ver la sección siguiente.
...
partir de cualquier agregación de datos del censo, y `mapa_man()` baja
hasta el manzano y la comunidad dentro de un municipio (sus geometrías
