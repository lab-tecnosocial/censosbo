...
Antes de descargar los datos completos, puedes explorar el perfil demográfico de los hogares con `sample_personas`:

```{r muestra-hogar, eval=TRUE, fig.width=7, fig.height=4}
library(censosbo)
library(dplyr)
library(ggplot2)
...
```{r muestra-alfabetismo, eval=TRUE, fig.width=7, fig.height=3.5}
...
> Los siguientes ejemplos requieren **descargar datos de vivienda** (~100 MB). Ejecuta el código en tu sesión de R después de instalar el paquete.
