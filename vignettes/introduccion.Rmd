...
El formato Parquet conserva todos los registros y variables originales sin modificación de valores. Los scripts de conversión están en `data-raw/` del [repositorio](https://github.com/lab-tecnosocial/censosbo).
