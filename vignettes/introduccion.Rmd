...
Los datos originales en CSV pesan más de 3 GB, por lo que el paquete los distribuye como archivos **Parquet** comprimidos (mucho más livianos y rápidos), que se descargan **bajo demanda** y se guardan en un caché local. No es necesario descargar todo: se puede pedir solo el departamento de interés.
