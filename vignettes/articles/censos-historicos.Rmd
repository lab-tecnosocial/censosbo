...
Para los cuatro, además del diccionario de microdatos, el paquete incorpora los
diccionarios DDI del catálogo ANDA del INE (estudios 8, 10, 47 y 46). Eso añade tres
...
Los capítulos (`capitulo`) son la única columna solo-2024: los cuestionarios anteriores
tienen otra estructura, y los de 1976 y 1992 numeran vivienda y persona en paralelo. La
columna existe vacía en los cuatro censos históricos, de modo que `codebook()` devuelve
la misma forma en los cinco años y se pueden combinar sin fricción.

### Etiquetas de valor completadas

Los DDI traen algunas etiquetas de valor que la extracción de REDATAM no recuperó, y se
usaron para rellenar huecos. La columna `valores_fuente` indica el origen
