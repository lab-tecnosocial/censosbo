...
- La población agregada por municipio coincide exactamente con
  `get_personas_2024()`, como se acaba de comprobar. Las **viviendas** dan un
  0,23% menos que `get_viviendas_2024()`, con un déficit sistemático (323
  municipios por debajo, ninguno por encima): el INE las cuenta distinto en el
  geoportal y en los microdatos. Para el total de viviendas de un territorio,
  usa `get_viviendas_2024()`.
